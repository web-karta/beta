...
popupState = {
  ...
  // 🚋 OKRETIŠTE (nije spremište) → uvijek vidljivo do sljedeće vožnje (ili zauvijek ako je nema)
  if (!prevEndsDepot) {
    pos = endPos;
    ...
    popupState = {
      ...
      routeKey: rk,
      networkRouteKey: nextKey || prevKey, // ako postoji sljedeća, highlightaj nju; inače ostaje zadnja
      nextStopName: null
    };
  }
